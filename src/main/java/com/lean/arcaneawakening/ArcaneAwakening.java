...
@Mod(ArcaneAwakening.MODID)
public class ArcaneAwakening {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "arcaneawakening";
    ...
    public ArcaneAwakening(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (ArcaneAwakening) to respond directly to events.
